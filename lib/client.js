...
Client.prototype.addSoapHeaderInside = function(name, value) {
  if (!this.soapHeadersInside) {
    this.soapHeadersInside = {};
  }
  this.soapHeadersInside[name] = name+'="'+value+'"';
};
Client.prototype.getSoapHeaderInside = function() {
  return this.soapHeaderInside;
};
Client.prototype.clearSoapHeaderInside = function() {
  this.soapHeaderInside = {};
};
...
Client.prototype._invoke = function(method, args, location, callback, options, extraHeaders) {
  ...
  xml = "<?xml version=\"1.0\" encoding=\"utf-8\"?>" +
    ...
    ((self.soapHeaders || self.security) ?
      (
        "<" + envelopeKey + ":Header"+(self.getSoapHeaderInside() ? self.getSoapHeaderInside().join(" ") : "")+">" +
